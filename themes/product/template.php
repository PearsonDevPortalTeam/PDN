 ...
 */
function product_preprocess_html(&$variables) {
  ...
  drupal_add_css(".dhtmmenu li a {background-color:none !important}", array('group' => CSS_THEME, 'type' => 'inline'));
  ...
  drupal_add_css(".dhtmmenu li.active-trail a{background-color:#F5F5F5}", array('group' => CSS_THEME, 'type' => 'inline'));
  drupal_add_css(".dhtmmenu li.active a{background-color:#F5F5F5}", array('group' => CSS_THEME, 'type' => 'inline'));
  drupal_add_css("ol li:hover{background-color:#2B3A9E}", array('group' => CSS_THEME, 'type' => 'inline'));
}

/**
 * Preprocessor for theme('page').
 */
function product_preprocess_page(&$variables) {
 ...
 */
function product_preprocess_region(&$variables, $hook) {
 ...
 */
function product_form_comment_form_alter(&$form, &$form_state) {
  hide($form['subject']);
  hide($form['author']);
 ...
 */
function product_css_alter(&$css) {
 ...
 */
function product_menu_link(array $variables) {
...
function product_form_user_login_alter(&$form, &$form_state, $form_id){
 global $base_url;
  $links = array(
